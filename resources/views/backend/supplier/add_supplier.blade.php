        ...
        <div class="row">
          <div class="col-sm-12 col-md-6">
            <div class="form-group mb-2">
              ...
              <input id="supplierName" name="supplierName" type="text" class="form-control @error('supplierName') is-invalid @enderror">
              @error('supplierName')
          ...
          <div class="col-sm-12 col-md-6">
            <div class="form-group mb-2">
              ...
              <input id="supplierEmail" name="supplierEmail" type="text" class="form-control @error('supplierEmail') is-invalid @enderror">
              @error('supplierEmail')
              <span class="text-danger"> {{ $message }} </span>
              @enderror
            </div>
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="form-group mb-2">
              ...
              <input id="supplierPhone" name="supplierPhone" type="text" class="form-control @error('supplierPhone') is-invalid @enderror">
              @error('supplierPhone')
              <span class="text-danger"> {{ $message }} </span>
              @enderror
            </div>
          ...
          <div class=" col-sm-12 col-md-6">
            <div class="form-group mb-2">
              ...
              <input id="supplierAddress" name="supplierAddress" type="text" class="form-control @error('supplierAddress') is-invalid @enderror">
