                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-md-6 mt-4">
                                                        ...
                                                        <p><strong>Order Status : </strong> <span class="float-end"><span
                                                                    class="badge bg-danger">{{ $order->orderStatus }}</span></span>
                                                        </p>
                                                ...
                                                <form id="complete-order-form" method="post"
                                                    action="{{ route('order.status.update') }}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <legend class="col-form-label pt-0">Received Amount *
                                                                </legend>
                            ...
                            <div class="col-12">
                                        ...
                                        <table class="table dt-responsive nowrap w-100">
                                            ...
                                            <tbody>
                                                @foreach ($orderItem as $item)
                                                    <tr>
                                                        <td> <img src="{{ asset($item->product->productImage) }}"
                                ...
                                <div class="text-end">
                                    <button type="button" class="btn btn-success" data-bs-toggle="modal"
                                        data-bs-target="#signup-modal">Pay Due</button>
                                </div>
                            </div>
                            <!-- end col-->
                        </div>
