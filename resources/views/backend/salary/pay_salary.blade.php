                            ...
                            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                                ...
                                <tbody>
                                    @foreach ($employee as $key => $item)
                                        <tr>
                                            <td>{{ $key + 1 }}</td>
                                            <td> <img src="{{ asset($item->employeeImage) }}"
                                                    style="width:50px; height: 40px;">
                                            </td>
                                            <td>{{ $item->employeeName }}</td>
                                            <td><span class="badge bg-info">
                                                    {{ date('F', strtotime('-1 month')) }} </span>
                                            </td>
                                            ...
                                            <td>
                                                @php
                                                    $amount =
                                                        $item->employeeSalary - $item['advance']['advance_salary'];
                                                @endphp
                                                <strong class="badge bg-danger"> {{ round($amount) }} </strong>
