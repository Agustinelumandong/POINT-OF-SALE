        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12">
            <div class="form-group mb-2">
              ...
              <textarea name="expenseDetails" id="expenseDetails" class="form-control" rows="3">{{ $expense->expenseDetails}}</textarea>
          ...
          <div class="col-sm-12 col-md-12">
            <div class="form-group mb-2">
              ...
              <input id="expenseAmount" name="expenseAmount" type="text" class="form-control @error('expenseAmount') is-invalid @enderror" value="{{ $expense->expenseAmount}}">
              @error('expenseAmount')
              <span class="text-danger"> {{ $message }} </span>
              @enderror
            </div>
