    ...
    <div class="container-fluid">
        ...
        <div class="logo-box">
            <a href="{{ url('/dashboard')}}" class="logo logo-dark text-center">
                ...
                <span class="logo-lg">
                    <img src="{{ asset('backend/assets/images/pos-logo-2.png') }}" alt="" height="50">
            ...
            <a href="index.html" class="logo logo-light text-center">
                <span class="logo-sm">
                    <img src="{{ asset('backend/assets/images/pos-logo.png') }}" alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img src="{{ asset('backend/assets/images/pos-logo.png') }}" alt="" height="20">
                </span>
            </a>
        </div>
